...
export default function ContactUs() {
  return (
    <div className="w-full flex flex-col md:flex-row items-center justify-center gap-10 px-4 py-10">
        <div className="flex flex-col items-center justify-center gap-10 w-full md:w-[40vw] px-6">
        ...
        <div className="max-w-md w-full md:w-[40vw] mx-6 p-6 bg-neutral-950 border border-neutral-900 text-neutral-100 rounded-2xl shadow-md mt-10 md:mt-20">
